from django.contrib.auth.models import User # готовая моделка user'a
from rest_framework import serializers

class RegisterSerializer(serializers.ModelSerializer):
    first_name = serializers.CharField(required=True) # обязательный к заполнению
    ...
    def create(self, validated_data):
        user = User.objects.create(**validated_data)   # **validated_data - расспаковка (именованные аргументы)
